...
class Token:
    ...
    def generate_token(self, username, password):
         # verifying the user and the plain password exist in the database. using the sha2 function to derive the encrypted password in the DB side.
        ...
        # verifying i got at least one record to generate the jwt token response.
            if record:
                ...
                return jwt_token
        # returning a 403 error message if the password and username dont exist in the DB as requested in the task.
